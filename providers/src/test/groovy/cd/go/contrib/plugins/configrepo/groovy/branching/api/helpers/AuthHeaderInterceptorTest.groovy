...
package cd.go.contrib.plugins.configrepo.groovy.branching.api.helpers

import cd.go.contrib.plugins.configrepo.groovy.branching.api.Api
import cd.go.contrib.plugins.configrepo.groovy.branching.api.mocks.MockedCall
import cd.go.contrib.plugins.configrepo.groovy.branching.api.mocks.MockedInterceptorChain
import cd.go.contrib.plugins.configrepo.groovy.branching.api.mocks.ResponseStub
import okhttp3.Call
...
class AuthHeaderInterceptorTest {
  ...
  void 'basic() injects a basic auth header'() {
    ...
    Api.bitbucketcloud(http).pullRequests("a", "b").execute()
